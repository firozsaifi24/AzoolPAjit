...
import com.example.firozsaifi.azoolp.adapter.RelatedSparePartAdsAdapter;
...
public class SparePartsDetailsFragment extends Fragment implements View.OnClickListener, OnAdsDetailCallback {
    ...
    TextView txt_name, txt_brand, txt_model, txt_year, txt_category, txt_date;
    String root= "http://azool.ae/multimedia/products/";

    //related products
    //recyclerview
    RecyclerView recyclerView_related_parts;
    //arraylist
    private ArrayList<Ads> adsList = new ArrayList<>();
    //adapters
    private RelatedSparePartAdsAdapter adsAdapter;
    ...
    public SparePartsDetailsFragment() {
        // Required empty public constructor
    }


    // TODO: Rename and change types and number of parameters
    public static SparePartsDetailsFragment newInstance(String param1, String param2) {
        SparePartsDetailsFragment fragment = new SparePartsDetailsFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_spare_parts_details, container, false);
        ...
        txt_category= view.findViewById(R.id.txt_part_cat);
        ...
        recyclerView_related_parts= view.findViewById(R.id.recycler_related_spare_parts);
        //horizontal layout manager
        RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(getActivity(), LinearLayoutManager.HORIZONTAL, false);
        //grid layout manager
        //GridLayoutManager adsGridLayoutManager= new GridLayoutManager(getActivity(),2);
        recyclerView_related_parts.setLayoutManager(mLayoutManager);
        recyclerView_related_parts.setScrollContainer(false);
        recyclerView_related_parts.setNestedScrollingEnabled(false);
    ...
    public void onAdsDetailSuccess(JSONObject adsDetail, ArrayList<Ads> carArrayList, ArrayList<Ads> spareArrayList) {
        ...
        adsList= spareArrayList;
        Log.d("Spare", String.valueOf(adsList.size()));

        if(adsList.size() != 0)
        {
            if(getActivity() != null) {
                adsAdapter = new RelatedSparePartAdsAdapter(getActivity(), adsList);
                recyclerView_related_parts.setAdapter(adsAdapter);

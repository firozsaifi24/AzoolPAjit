...
public class DescriptionDialogFragment extends DialogFragment implements View.OnClickListener {
    ...
    public static DescriptionDialogFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        description= view.findViewById(R.id.txt_description_content_products);
        close= view.findViewById(R.id.img_close);
        root= view.findViewById(R.id.root);
        close.setOnClickListener(this);
        root.setOnClickListener(this);

        description.setText(getArguments().getString(ARG_PARAM2));

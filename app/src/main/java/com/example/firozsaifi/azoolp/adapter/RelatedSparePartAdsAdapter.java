...
public class RelatedSparePartAdsAdapter extends RecyclerView.Adapter {

    private Context mContext;
    private ArrayList<Ads> adsArrayList;
    String root= "http://azool.ae/multimedia/products/";

    public RelatedSparePartAdsAdapter(Context mContext, ArrayList<Ads> adsArrayList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item_related_products_spare_parts, parent,false);
    ...
    private class AdsHolder extends  RecyclerView.ViewHolder implements View.OnClickListener
    {
        ...
        public AdsHolder(View itemView) {
            ...
            itemLayout=itemView.findViewById(R.id.item_related_products_spare_parts);
        ...
        public void onClick(View v) {
            switch(v.getId())
            {
                ...
                /*case R.id.txt_view_shop:
                    ...
                    break;
*/
                case R.id.item_related_products_spare_parts:

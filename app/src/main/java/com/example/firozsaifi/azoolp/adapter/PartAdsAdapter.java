...
public class PartAdsAdapter extends RecyclerView.Adapter {

    private Context mContext;
    private ArrayList<Ads> adsArrayList;
    String root= "http://azool.ae/multimedia/products/";

    public PartAdsAdapter(Context mContext, ArrayList<Ads> adsArrayList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item_spare_parts_ads, parent,false);
    ...
    private class AdsHolder extends  RecyclerView.ViewHolder implements View.OnClickListener
    {
        ...
        public AdsHolder(View itemView) {
            ...
            itemLayout=itemView.findViewById(R.id.item_spare_parts_ads);
        ...
        public void onClick(View v) {
            switch(v.getId())
            {
                ...
                case R.id.item_spare_parts_ads:
